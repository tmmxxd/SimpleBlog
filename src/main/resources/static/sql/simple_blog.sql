...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章设置标签表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for set_article_sort
-- ----------------------------
DROP TABLE IF EXISTS `set_article_sort`;
...
CREATE TABLE `user_friends`  (
  ...
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户好友表' ROW_FORMAT = Dynamic;
