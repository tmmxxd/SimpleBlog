...
public class H2CodeGeneratorTest {
    ...
    public static void before() throws SQLException {
        ...
        InputStream inputStream = H2CodeGeneratorTest.class.getResourceAsStream("/sql/simple_blog.sql");
    ...
    private StrategyConfig.Builder strategyConfig() {
        return new StrategyConfig.Builder().addInclude("articles"); // 设置需要生成的表名
    }
